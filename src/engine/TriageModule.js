...
// Framework-agnóstico: funciona en React Native, Node.js (WhatsApp bot), navegador
// Protocolos basados en: Cruz Roja Internacional · PHTLS · ATLS · WHO EFA
//
// INTEGRACIÓN WHATSAPP:
//   const triage = require('./TriageModule');
//   const respuesta = triage.process_message("me está sangrando mucho");
//   // → enviar respuesta.text al usuario vía Twilio/Baileys/Meta API
...
class TriageModule {
  ...
  /**
   * Procesa mensaje de texto libre (entrada de WhatsApp).
  ...
  /**
   * Retorna el protocolo completo formateado para WhatsApp por su ID.
